...
#ifndef SAPOTE_UI_FONT_H
#define SAPOTE_UI_FONT_H
...
int32_t sapote_ui_font_self_test(void);
size_t sapote_ui_font_size(void);
uint64_t sapote_ui_font_fingerprint(void);
int32_t sapote_ui_font_geometry(struct ui_font_metrics *metrics);
int32_t sapote_ui_font_glyph(
    uint32_t code,
    uint8_t *out,
    size_t out_len
);
