...
#ifndef SAPOTE_PM_TIMER_H
#define SAPOTE_PM_TIMER_H
 ...
 * original PC clock chain was built from. Sapote does not measure this rate
...
/*
 * Sapote agreement policy, not an ACPI rule. Two measurements of one interval
