...
#ifndef SAPOTE_THREAD_H
#define SAPOTE_THREAD_H
...
/*
 * A Sapote policy bound on how many threads may exist at once, not an
 ...
 * error against it. It is a Sapote policy number, not an architectural one.
 */
