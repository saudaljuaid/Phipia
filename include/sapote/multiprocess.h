...
#ifndef SAPOTE_MULTIPROCESS_H
#define SAPOTE_MULTIPROCESS_H
...
uint32_t sapote_multiprocess_elf64_self_test(void);
enum elf64_status sapote_multiprocess_elf64_parse(
    const uint8_t *input,
    size_t input_len,
