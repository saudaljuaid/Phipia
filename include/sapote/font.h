...
#ifndef SAPOTE_FONT_H
#define SAPOTE_FONT_H
 ...
 * printed, so this is the first Rust in Sapote on a hot path.
 *
 ...
 * buffer a caller must offer sapote_font_glyph. src/rust/font.rs refuses
 ...
 */
int32_t sapote_font_glyph(uint32_t code, uint8_t *out, size_t out_len);
