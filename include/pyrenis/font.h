...
#ifndef PYRENIS_FONT_H
#define PYRENIS_FONT_H
 ...
 * printed, so this is the first Rust in Pyrenis on a hot path.
 *
 ...
 * buffer a caller must offer pyrenis_font_glyph. src/rust/font.rs refuses
 ...
 */
int32_t pyrenis_font_glyph(uint32_t code, uint8_t *out, size_t out_len);
