...
#define UI_CURSOR_WIDTH 12U
#define UI_CURSOR_HEIGHT 18U
...
enum ui_element_id {
    ...
    UI_ELEMENT_DOCK_LEDGER,
    UI_ELEMENT_DOCK_SYSTEM,
...
enum ui_action {
    UI_ACTION_NONE = 0,
    UI_ACTION_TOGGLE_TERMINAL,
    UI_ACTION_TOGGLE_LEDGER,
    UI_ACTION_TOGGLE_SYSTEM,
    UI_ACTION_TOGGLE_ABOUT,
    UI_ACTION_COUNT
};
...
struct ui_theme {
    ...
    uint32_t bronze;
    uint32_t deep_brown;
    uint32_t muted_bronze;
    uint32_t pale_bronze;
};
