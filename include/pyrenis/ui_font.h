...
#ifndef PYRENIS_UI_FONT_H
#define PYRENIS_UI_FONT_H
...
int32_t pyrenis_ui_font_self_test(void);
size_t pyrenis_ui_font_size(void);
uint64_t pyrenis_ui_font_fingerprint(void);
int32_t pyrenis_ui_font_geometry(struct ui_font_metrics *metrics);
int32_t pyrenis_ui_font_glyph(
    uint32_t code,
    uint8_t *out,
    size_t out_len
);
