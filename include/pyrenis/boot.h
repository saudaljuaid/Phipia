...
#ifndef PYRENIS_BOOT_H
#define PYRENIS_BOOT_H
 ...
 */
#define PYRENIS_EARLY_PHYSICAL_LIMIT UINT64_C(0x100000000)
 ...
 * same tag, and Pyrenis refuses each by name rather than guessing.
 */
