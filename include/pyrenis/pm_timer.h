...
#ifndef PYRENIS_PM_TIMER_H
#define PYRENIS_PM_TIMER_H
 ...
 * original PC clock chain was built from. Pyrenis does not measure this rate
...
/*
 * Pyrenis agreement policy, not an ACPI rule. Two measurements of one interval
