...
#ifndef PYRENIS_THREAD_H
#define PYRENIS_THREAD_H
...
/*
 * A Pyrenis policy bound on how many threads may exist at once, not an
 ...
 * error against it. It is a Pyrenis policy number, not an architectural one.
 */
