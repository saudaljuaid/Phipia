...
#ifndef PYRENIS_PAGING_H
#define PYRENIS_PAGING_H
...
/*
 * How much of a firmware-declared PCI Express configuration window Pyrenis makes
 ...
 * configuration space, which is every bus any machine Pyrenis is tested on
 ...
 * by precedence. There is deliberately no user flag: every entry Pyrenis writes
