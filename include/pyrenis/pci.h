...
#ifndef PYRENIS_PCI_H
#define PYRENIS_PCI_H
 ...
 * present on every PC since PCI existed. It is what Pyrenis enumerates through.
 */
...
/*
 * A Pyrenis early-boot policy bound on how many functions one enumeration may
