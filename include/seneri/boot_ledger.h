...
#ifndef SENERI_BOOT_LEDGER_H
#define SENERI_BOOT_LEDGER_H
...
/*
 * OpenSeneri's boot graph and its evidence are deliberately bounded. Neither
...
#define BOOT_STAGE_CAPABILITY_CAPACITY 8U
