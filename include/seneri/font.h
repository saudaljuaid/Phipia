...
#ifndef SENERI_FONT_H
#define SENERI_FONT_H
 ...
 * buffer a caller must offer seneri_font_glyph. src/rust/font.rs refuses
 ...
 */
int32_t seneri_font_glyph(uint32_t code, uint8_t *out, size_t out_len);
