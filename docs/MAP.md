...
| `boot_plan.c` | 2131 | The installed descriptors, typed dependency declarations, context population and private stage execution functions. |
...
| File | | |
| --- | ---: | --- |
| `test.c` | 4736 | The thirty-four QEMU scenarios and what each must print. |
