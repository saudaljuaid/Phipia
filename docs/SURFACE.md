...
```text
Sapote: surface 1024x768 pitch 4096 buffer 3145728 bytes
Sapote: surface cycles full present <cycles> one-line update <cycles> scroll <cycles>
Sapote: surface split cycles full draw <cycles> push <cycles> one-line draw <cycles> push <cycles> scroll draw <cycles> push <cycles>
Sapote: surface sparse two-corner cycles total <cycles> draw <cycles> push <cycles> union 786432
Sapote: surface copied 786432 full, 16384 line, 786432 scroll pixels
Sapote: cached surface established
```
