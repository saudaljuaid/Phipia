...
This milestone gives OpenSeneri a deterministic failure boundary. Every x86_64 IDT
...
selectors while the bootstrap GDT is still active. OpenSeneri then loads the
