...
Sapote had three clocks that agreed and nothing that could use them. Each one
...
```text
Sapote: monotonic clock on time-stamp counter
```
...
```text
Sapote: monotonic clock on time-stamp counter
Sapote: slept 50516366 ns for a 50000000 ns deadline
Sapote: deadline timers online
Sapote: monotonic time established
```
