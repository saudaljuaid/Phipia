...
Pyrenis had three clocks that agreed and nothing that could use them. Each one
...
```text
Pyrenis: monotonic clock on time-stamp counter
```
...
```text
Pyrenis: monotonic clock on time-stamp counter
Pyrenis: slept 50516366 ns for a 50000000 ns deadline
Pyrenis: deadline timers online
Pyrenis: monotonic time established
```
