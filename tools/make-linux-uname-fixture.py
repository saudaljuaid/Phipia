...
BUSYBOX_SHA256 = "566E0139BE6E4D01C4FCCC0BCC812661756D2069EEC6606CB9BA11C8EC3AE003"
IMAGE_SHA256 = "4097ADC246B54DB7F1A2A9A895DE824AA5FEE1CD22ECB8AB352B0E9F171DFC5B"
...
def verify_busybox(binary: bytes) -> None:
    ...
    expected = [
        ...
        (1, 5, 0x1000, 0x400001001000, 0x400001001000, 0x6D79, 0x6D79, 0x1000),
