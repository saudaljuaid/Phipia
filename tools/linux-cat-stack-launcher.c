...
static const struct measured_segment measured_segments[] = {
    ...
    {UINT64_C(0x400001001000), 0x1000U, 0x6f72U, 0x6f72U,
     PROT_READ | PROT_EXEC},
    {UINT64_C(0x400001008000), 0x8000U, 0x118eU, 0x118eU, PROT_READ},
    {UINT64_C(0x40000100a1a0), 0x91a0U, 0x0316U, 0x1188U,
...
int main(void)
{
    ...
    static const char argv_one[] = "cat";
    ...
    cursor = (cursor - 9U * sizeof(uint64_t)) & ~(uintptr_t)15U;
    ...
    initial_stack[3] = 0U;
    initial_stack[4] = 0U;
    initial_stack[5] = AT_PAGESZ_VALUE;
    initial_stack[6] = PAGE_BYTES;
    initial_stack[7] = AT_NULL_VALUE;
    initial_stack[8] = 0U;
