...
"""Compare actual Sapote Redwood QEMU frames using bounded stable regions."""
...
# Sapote Redwood exposes no timing, addresses, counters, or other variable fields
...
def compare_pixels(reference, candidate, mode):
    ...
    return True, "all stable Sapote Redwood pixels match"
