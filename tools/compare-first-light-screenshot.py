...
"""Compare actual First Light QEMU frames using bounded stable regions."""
...
# First Light exposes no timing, addresses, counters, or other variable fields
...
def compare_pixels(reference, candidate, mode):
    ...
    return True, "all stable First Light pixels match"
