...
"""Capture three deterministic Sapote Redwood frames from a live QEMU guest.
...
CAT_WAIT_LINE = b"RW USERLAND cat foreground launch yielded to Sapote Redwood"
...
def main():
    ...
    try:
        ...
        time.sleep(0.12)
        clean = capture(qmp, output, "sapote-redwood-proof")
        ...
        for dx, dy in ((230, -226), (235, -227)):
            ...
            time.sleep(0.08)
        focus = capture(qmp, output, "sapote-redwood-proof-focus")
        ...
        time.sleep(0.20)
        terminal = capture(qmp, output, "sapote-redwood-proof-terminal")
        print(clean)
        print(focus)
        print(terminal)
    finally:
