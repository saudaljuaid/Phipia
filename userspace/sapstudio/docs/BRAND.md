...
[`assets/sapstudio-logo.png`](../assets/sapstudio-logo.png) is the source of
...
The mark supplies no interface palette. SapStudio's palette exists to serve one
...
Accents are borrowed from Sapote's First Light palette deliberately: the two
