...
def named(crate: str) -> str:
    ...
    return crate if crate.startswith("sapstudio") else f"(rust: {crate})"
...
WITNESSES = (
    ...
    ("_RNvCs6BcOe5Imze2_12sapstudio_rt4HEAP", "sapstudio_rt"),
    # v0, a method on a type in a module.
    (
        "_RNvMNtCs6oV4Mx6d6CN_15sapstudio_model4editNtB2_4Edit5apply",
        "sapstudio_model",
    ),
    ...
    ("_ZN12sapstudio_io6format6encode17h0123456789abcdefE", "sapstudio_io"),
