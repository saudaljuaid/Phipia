...
use sapstudio_abi::seam::SeamStatus;
use sapstudio_model::ModelStatus;
...
pub enum IoStatus {
    ...
    OutOfMemory,
    /// The file does not begin with the SapStudio project magic.
    NotAProjectFile,
    ...
    Media(sapstudio_media::MediaStatus),
    /// A summary the audio crate refused to hold.
    Sound(sapstudio_audio::AudioStatus),
    ...
    CubeOutOfRange,
    /// The file does not begin with the SapStudio reel magic.
    NotAReel,
...
impl IoStatus {
    ...
    pub const fn describe(self) -> &'static str {
        match self {
            ...
            Self::NotAProjectFile => "the file is not a SapStudio project",
...
impl From<sapstudio_core::CoreStatus> for IoStatus {
    fn from(status: sapstudio_core::CoreStatus) -> Self {
        Self::Model(ModelStatus::Time(status))
    }
}

impl From<sapstudio_media::MediaStatus> for IoStatus {
    fn from(status: sapstudio_media::MediaStatus) -> Self {
        Self::Media(status)
    }
}

impl From<sapstudio_audio::AudioStatus> for IoStatus {
