...
pub enum Edit {
    ...
    SetClipFades {
        ...
        fade_in: sapstudio_core::Duration,
        /// And to go back down.
        fade_out: sapstudio_core::Duration,
    },
    ...
    /// about. A marker that belongs to a *clip* and travels with it is a
    /// different feature with a different name.
    AddMarker {
        /// Where the note goes.
        at: sapstudio_core::Instant,
    ...
    MoveMarker {
        /// Where it is.
        from: sapstudio_core::Instant,
        /// Where it goes.
        to: sapstudio_core::Instant,
    },
...
fn refade(
    ...
    fade_in: sapstudio_core::Duration,
    fade_out: sapstudio_core::Duration,
) -> Result<(sapstudio_core::Duration, sapstudio_core::Duration)> {
    let Item::Clip(clip) = lane.item(index)?.clone() else {
