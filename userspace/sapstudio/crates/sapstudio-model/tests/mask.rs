...
use sapstudio_model::{Clip, Edit, Item, Mask, MediaAsset, ModelStatus, Project, TrackKind};
...
fn mask_of(project: &Project, sequence: sapstudio_model::SequenceId) -> Option<Mask> {
