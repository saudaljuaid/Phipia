...
use sapstudio_core::{CoreStatus, Duration, Instant, Timebase};
use sapstudio_model::media::Digest;
use sapstudio_model::{Clip, Item, MediaAsset, MediaId, ModelStatus, Track, TrackKind};
...
fn media_id() -> MediaId {
    ...
    let mut project = sapstudio_model::Project::new();
