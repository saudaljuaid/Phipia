...
impl Face {
    /// The one face SapStudio has: capitals, lowercase, digits, punctuation.
    #[must_use]
...
pub fn block(
    ...
    // last line hangs below that, deliberately -- a card of "SAP" and a card
    // of "Sap" sit in the same place, which they would not if the block's
