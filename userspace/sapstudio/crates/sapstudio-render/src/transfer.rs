...
use sapstudio_media::TransferFunction;

use crate::status::{RenderStatus, Result};
use sapstudio_core::Fixed;

/// An exact decimal, as a standard prints it.
fn constant(numerator: i64, denominator: i64) -> sapstudio_core::Result<Fixed> {
