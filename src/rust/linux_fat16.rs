...
pub const UNAME_SHA256: [u8; 32] = [
    0x56, 0x6E, 0x01, 0x39, 0xBE, 0x6E, 0x4D, 0x01, 0xC4, 0xFC, 0xCC, 0x0B, 0xCC, 0x81, 0x26, 0x61,
    0x75, 0x6D, 0x20, 0x69, 0xEE, 0xC6, 0x60, 0x6C, 0xB9, 0xBA, 0x11, 0xC8, 0xEC, 0x3A, 0xE0, 0x03,
];
